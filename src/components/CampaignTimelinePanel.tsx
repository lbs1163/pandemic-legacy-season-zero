...
import type { CampaignState, CharacterProfile } from '../types/campaign';
          ...
          <TableBody>
            {records.length ? records.map((record) => (
              <TableRow key={record.id}>
                ...
                <TableCell>{record.characters.length ? record.characters.map(formatCharacter).join(', ') : record.players.map((player) => player.name).join(', ')}</TableCell>
