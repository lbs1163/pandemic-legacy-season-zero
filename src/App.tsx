...
export function App() {
  ...
  function recordGameResult(input: { playedAt?: string; missionResults: MissionResult[]; maySouthAmericaControlCenterCityId?: string; julyAfricaControlCenterCityId?: string }) {
